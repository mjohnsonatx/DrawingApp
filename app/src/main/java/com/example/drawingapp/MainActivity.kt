...
class MainActivity : AppCompatActivity() {
    ...
    private val accessMemoryLauncher : ActivityResultLauncher<Array<String>> =
            ...
            val isGranted = it.value
                ...
                if(isGranted){
                    if(permissionName == Manifest.permission.READ_EXTERNAL_STORAGE){
                        Toast.makeText(this,"Permission granted for memory",
                        ...
                        if(permissionName == Manifest.permission.READ_EXTERNAL_STORAGE){
                            Toast.makeText(this, "Permission not granted for memory",
                                Toast.LENGTH_SHORT).show()
                        }
                    }
                }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnGalleryPermission : ImageButton = findViewById(R.id.ic_gallery)
        btnGalleryPermission.setOnClickListener{
        ...
        ibSave.setOnClickListener{
            ...
            if(isReadStorageAllowed()){
                ...
                lifecycleScope.launch{
                    //use the bitmap that sandwhiches the two drawing views together
    ...
    // a dialog is like a pop-up on the screen
    ...
    private fun requestStoragePermission(){
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M &&
            ...
            showRationaleDialog("Memory access required to use gallery", "Gallery cannot be used because access to memory is denied")
        }else{
            accessMemoryLauncher.launch(arrayOf(
                Manifest.permission.READ_EXTERNAL_STORAGE,
        ...
        withContext(Dispatchers.IO){
            if(mBitmap != null){
                try{
                    ...
                    // compressing the bitmap for ostream
    ...
    //sharing the saved image with your homies
